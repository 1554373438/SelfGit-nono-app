(function() {
  ...
  /** @ngInject */
  function InvestDetailController($state, $stateParams, $scope, $ionicScrollDelegate, BasicApi, localStorageService, OrderService, utils, user, AppService, toastr, EbankService, AgreementService) {
    var vm = this,
    ...
    function showTemplate() {
       AgreementService.getTemplate({type: 6, productId: id, name: '借款协议'});
    }
