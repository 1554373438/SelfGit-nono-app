(function() {
  ...
  /** @ngInject */
  function InvestDetailController(utils, $state, $stateParams, BasicApi, OrderService, user, AppService, EbankService, $rootScope, AgreementService) {
    var vm = this,
    ...
    function showTemplate() {
      AgreementService.getTemplate({type: 1, productId: id, name: '债权转让协议'});
    }
  }
})();
